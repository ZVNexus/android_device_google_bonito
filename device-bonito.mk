...
DEVICE_PACKAGE_OVERLAYS += $(LOCAL_PATH)/bonito/overlay

PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/nfc/libnfc-nxp.bonito.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-nxp.conf
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/vibrator/drv2624/drv2624_B4.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/drv2624.bin
